...
<title>MyLunchOrder.Online Account Activation</title>
	...
	<div style="max-width: 600px; margin:0 auto;">
		...
		<div style ="display:block; position:relative; padding:25px; background-color: #eef0f3">
			  <div style="display: block; position: relative;padding: 32px;background-color: #fff;border-radius: 10px;box-shadow: 0px 0px 10px #e2e2e2;">
			  	  ...
			  	  <p>Congratulation you’re all set!</p>
			  	  <p>Welcome to your MyLunchOrder.Online platform.</p>
			  	  <p>Happy selling!</p>
			  	  <p>If you have any queries, send us an email at <a href="mailto:support@loggedin.com.au">support@loggedin.com.au</a></p>
