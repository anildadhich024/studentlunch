...
<style type="text/css">
	*{font-family: 'Roboto', sans-serif;margin:0px;padding: 0px;}
	...
	h3{color: #000; font-size: 26px;font-weight: 300;margin-bottom: 15px;}
	p{color: #555555;font-size: 19px;font-weight: 300;margin-bottom: 10px;line-height: 30px;}
</style>
</head>
	...
	<div style="max-width: 600px; margin:0 auto;">
		...
		<div style ="display:block; position:relative; padding:25px; background-color: #eef0f3">
			  <div style="display: block; position: relative;padding: 32px;background-color: #fff;border-radius: 10px;box-shadow: 0px 0px 10px #e2e2e2;">
				  <p><strong>Hi</strong>,<br><i>Welcome to Students Lunch!</i></p>
				  <p>You have received this message because you have requested to reset the password.</p>
				  <p style="text-align: center;">Your OTP is</p>
				  <p style="text-align: center;"><strong>{{$lCode}}</strong></p>
			  </div>
			   <div style="display:block; position:relative; padding: 15px;">
                     ...
                     <p style="text-align: center;font-size: 16px;color: #555555;line-height: 22px;">If it wasn't you who requested for OTP, then Ignore this email and please don't share OTP to anyone.</p>
			   </div>
		</div>
	</div>
</body>
