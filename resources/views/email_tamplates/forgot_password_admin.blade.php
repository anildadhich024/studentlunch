...
<title>Welcome to Student Lunch</title>
	...
	<div style="max-width: 600px; margin:0 auto;">
		...
		<div style ="display:block; position:relative; padding:25px; background-color: #eef0f3">
			  <div style="display: block; position: relative;padding: 32px;background-color: #fff;border-radius: 10px;box-shadow: 0px 0px 10px #e2e2e2;">
			  	  <p><strong>Hi {{$sUserName}}</strong></p>
			  	  <p>You recently requested to reset your password for your account. Click the button below to reset it.</p>
			  	  <!-- <p style="text-align: center;"><a href="https://mylunchorder.online/admin_panel/reset_password?token={{base64_encode($sToken)}}" style="display: inline-block;background-color: #203869;color: #fff;position: relative;border-radius: 60px;padding: 12px 30px;text-decoration: none;">Reset Password</a></p> -->
			  	  <p style="text-align: center;"><a href="https://studentlunch.i4acmmosmedia.com/admin_panel/reset_password?token={{base64_encode($sToken)}}" style="display: inline-block;background-color: #203869;color: #fff;position: relative;border-radius: 60px;padding: 12px 30px;text-decoration: none;">Reset Password</a></p>
			  	  <p style="text-align: left;">If you did not request a password reset, please ignore this email. This password reset is only valid for the next 30 minutes.</p>
			  	  <p style="text-align: left;">If you are having trouble clicking the password reset button, copy and paste the URL below into you web browser</p>
			  	  <!-- <p style="text-align: left;"><a href="https://mylunchorder.online/admin_panel/reset_password?token={{base64_encode($sToken)}}">https://mylunchorder.online/admin_panel/reset_password?token={{base64_encode($sToken)}}</a></p> -->
					<p style="text-align: left;"><a href="https://studentlunch.i4acmmosmedia.com/admin_panel/reset_password?token={{base64_encode($sToken)}}">https://studentlunch.i4acmmosmedia.com/admin_panel/reset_password?token={{base64_encode($sToken)}}</a></p>
				</div>
			   <div style="display:block; position:relative; padding: 15px;">
                     ...
                     <p style="text-align: center;font-size: 16px;color: #555555;line-height: 22px;">If it wasn't you who submitted your email address inthe first place, well then that's messed up and we apologies for this error. Ignore this email and please don't click the above button. You will not receive any further email from us.</p>
			   </div>
		</div>
	</div>
</body>
