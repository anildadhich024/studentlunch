	...
	<div style="max-width: 600px; margin:0 auto;">
		...
		<div style ="display:block; position:relative; padding:25px; background-color: #eef0f3">
			  <div style="display: block; position: relative;padding: 32px;background-color: #fff;border-radius: 10px;box-shadow: 0px 0px 10px #e2e2e2;">
			  	  ...
			  	  <p>You are now part of a community that is helping local businesses with support of technology capabilities.</p>
			  	  <p>We would like to welcome you and your child to MyLunchOrder.Online platform and personally take the opportunity to thank you for signing up to our services.</p>
			  	  <p>MyLunchOrder.Online has been established keeping in mind not only the local businesses but also the parents (i.e. you guys). We would also like to give you an opportunity for at least a day in the week where you need not to worry about preparing school lunch – enabler for a relaxed and pleasant start of a new day!</p>
			  	  <p>Our aim with this product is to help improve the wellbeing of the parents whilst also help our local community businesses to get back on their feet post the distraction COVID-19 has left us all with therefore, we humbly and whole heartedly thank you for your support.</p>
