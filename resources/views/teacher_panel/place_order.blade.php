    ...
    <div id="dashboardPage">
        ...
        <main>
            ...
            <div class="container-fluid card-commission-section my-form my-credits-section">
                <form action="{{ url('teacher_panel/place_order/save') }}" method="post"
                    id="general_form">
                    ...
                    <div class="row first-block">
                        <div class='col-6 col-lg-3 col-md-6 pb-2 from-boxes'>
                            <label>Date</label>
                            <input type="date" id="sDtTm" name="sDtTm" min="{{ !empty($aCart) ? $aCart['sDelvDate'] : '' }}"
                                required>
                        </div>
...
$(document).ready(function () {
    ...
    $.ajax({
        url: "teacher_panel/get_milk?sDtTm=" + $('#sDtTm').val(),
            ...
            if (schlId == 0) {
                ...
                $.ajax({
                    url: "get_menu/list?milkbar=" + optionSelected.val() +
                        "&nUserType={{ config('constant.USER.TEACHER') }}",
                    success: function (result) {
