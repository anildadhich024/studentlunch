@include('admin_panel.layouts.header')
    <div class="page-container animsition">
        <div id="dashboardPage">
            ...
            <form action="{{url('teacher_panel/change_password/save')}}" method="post" id="general_form">
                        ...
                        <div class="row">
                            <div class="col-lg-12 services-btns">
                                <ul class="m-auto text-center pt-4 pb-4">
                                    ...
                                    <li>
                                        <div class="add-btn  mt-0"><button title="Change Password" type="submit" class="mt-0">Update</button></div>
                                    </li>
                                </ul>
                            </div>
                        </div>
