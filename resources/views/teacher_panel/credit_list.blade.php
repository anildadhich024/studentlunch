        ...
        <div id="dashboardPage">
            ...
            <main>
                ...
                <div class="container-fluid card-commission-section">
                    <form action="{{url('teacher_panel/my_credits')}}" method="get" id="credit_form">
...
$('#ExprtRcrd').on('click', function() {
    ...
    else
    {
        ...
        window.location=APP_URL+"/teacher_panel/my_credits/export?sFrmDate="+sFrmDate+"&sToDate="+sToDate+"&lSchlIdNo="+lSchlIdNo+"&sOrdrId="+sOrdrId;
    }
});
