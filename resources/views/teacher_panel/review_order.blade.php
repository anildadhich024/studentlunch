					...
					<div class="row pt-4">
						<div class="col-sm-12 col-lg-12 commssions-table-details table-responsive">
							<table>
								...
								<tr>
									<td>{{$aTchrDtl['sFrst_Name']." ".$aTchrDtl['sLst_Name']}}</td>
									<td>{{$aTchrDtl['sSchl_Name']}}</td>
									<td>{{array_search($aTchrDtl['nSchl_Type'], config('constant.SCHL_TYPE'))}}</td>
					...
					<div class="row pt-4">
						<div class="col-lg-12 services-btns">
							<ul class="m-auto text-center pt-4 pb-4">
								<li>
									<div class="add-btn  mt-0"><button title="Change Order"  onclick="javascript:location.href='teacher_panel/place_order'" class="mt-0" >Change Order</button></div>
								</li>
								<li>
									<div class="add-btn payment-btn mt-0 mtautomedia364"><button title="Proceed to Payment" class="mt-0" onClick="document.location.href='teacher_panel/checkout'">Proceed to Payment</button></div>
								</li>
							</ul>
						</div>
					</div>
