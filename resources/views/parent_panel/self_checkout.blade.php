            ...
            <main>
				...
				<div class="container-fluid p-0">     
					<div class="row">
						...
						<div class="col-6 col-lg-6 col-sm-6 payment-box ">
							<div class="payment-box-inner  card-commission-section  parent-details-section">
								<h4 class="mb-0 pb-4" style="padding-bottom: 0.8rem !important;">Pick Up Order</h4>
								<table width="100%">
									<tr>
										<td class="tbl_hdng" width="35%">Order OTP</td>
										<td class="tbl_hdng" width="35%">Parent Name</td>
										<td class="tbl_hdng" width="30%">Pick Up Time</td>
									</tr>
									<tr height="10"></tr>
									<tr>
										@php
											$nOTP = rand(1111,9999);
										@endphp
										<td class="tbl_dtl" width="35%">{{ $nOTP }}</td>
										<td class="tbl_dtl" width="35%">{{ $aPrntDtl['sFrst_Name']}} {{$aPrntDtl['sLst_Name'] }}</td>
										<td class="tbl_dtl" width="30%"><input type="time" onBlur="getTime(this.value)" class="@error('sPicTm') is-invalid @enderror"></td>
									</tr>
								</table>
							</div>
							<div class="payment-box-inner  card-commission-section  parent-details-section">
								<h4 class="mb-3">Process Payment </h4>
								<form role="form" action="{{ route('checkout.parent.self.stripe') }}" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="{{ env('STRIPE_KEY') }}" id="payment-form">
									@csrf
									...
									<input class='form-control' type='hidden' name="nOrderType" value="909">
									<input class='form-control' type='hidden' name="sPicTm" id="sPicTm">
									<input class='form-control' type='hidden' name="nOTP" value="{{$nOTP}}">
								...
								<form role="form" action="{{ route('checkout.parent.self.credit') }}" method="post" class="cr-pay d-none" id="general_form">
									<input class='form-control' type='hidden' name="nOrderType" value="909">
									<input class='form-control' type='hidden' name="sPicTm" id="sPicTm">
									<input class='form-control' type='hidden' name="nOTP" value="{{$nOTP}}">
									@csrf 
