					...
					<div class="row pt-4">
						<div class="col-sm-12 col-lg-12 commssions-table-details table-responsive">
							<table>
								...
								<tr>
									<td>{{$aPrntDtl['sFrst_Name']." ".$aPrntDtl['sLst_Name']}}</td>
									<td>{{$aSchlDtl['sBuss_Name']}}</td>
								</tr>
							</table>
						</div>
					</div>
					...
					<div class="row pt-4">
						<div class="col-lg-12 services-btns">
							<ul class="m-auto text-center pt-4 pb-4">
								<li>
									<div class="add-btn  mt-0"><button title="Change Order"  onclick="javascript:location.href='parent_panel/self/place_order'" class="mt-0" >Change Order</button></div>
								</li>
								<li>
									<div class="add-btn payment-btn mt-0 mtautomedia364"><button title="Proceed to Payment" class="mt-0" onClick="document.location.href='parent_panel/self/checkout'">Proceed to Payment</button></div>
								</li>
							</ul>
						</div>
					</div>
