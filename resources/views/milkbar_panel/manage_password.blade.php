                        ...
                        <div class="row">
                            <div class="col-lg-12 services-btns">
                                <ul class="m-auto text-center pt-4 pb-4">
                                    <li>
                                        <div class="add-btn  mt-0 pt-3"><button title="Back" class="mt-0" onclick="history.back()">Back</button></div>
                                    </li>
                                    <li>
                                        <div class="add-btn  mt-0 pt-3"><button title="Change Password" type="submit" class="mt-0">Update</button></div>
                                    </li>
                                </ul>
                            </div>
                        </div>
